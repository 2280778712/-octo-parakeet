<template>
    <div class="fourpage" :style="{height:$store.state.height}">
      <Popup :is-show="status.isShowPublish"
      :backimg="status.bgInfo"
      :top-distance="status.topNum"
      :boxHeight="status.boxHeight"
    ...
    data(){
      return {
        ...
        status:{
                isShowPublish:false,
                topNum:14,
                bgInfo:'../../../static/img/fourpage/dialog.png',
                boxHeight:30,
